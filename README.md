...
This portfolio showcases my work in baseball analytics and data science, with a focus on predictive modeling, statistical analysis, and applied research. My projects demonstrate expertise in machine learning, statistical modeling, data visualization, and the ability to translate complex analytical insights into actionable recommendations.
